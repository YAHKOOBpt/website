...
def index(request):
    ...
    bg_image4 = Background_image4.objects.all()
    bg_image5 = Background_image5.objects.all()
    reviews = Review.objects.all()

    context = {'treatments':treatments, 'staffs':staffs, 'bg_image':bg_image, 'bg_image2':bg_image2, 'bg_image3':bg_image3, 'bg_image4':bg_image4, 'bg_image5':bg_image5, 'reviews':reviews}
...
def general_info(request):
    ...
    context = {'treatments':treatments, 'bg_image5':bg_image5, 'aboutus':aboutus}
...
def bg2(request):
    bg4 = Background_image4.objects.all()
    bg5 = Background_image5.objects.all()

    context = {'bg4':bg4, 'bg5':bg5}

    return render(request, 'nechuadmin/bg2.html', context)


def aboutus(request):
    aboutus = Aboutus.objects.all()
    context = {'aboutus':aboutus}
    return render(request, 'nechuadmin/aboutus.html', context)
...
def add_image(request):
    ...
    e = Image_category.objects.filter(category=d).first()
    images = Image(title=a, image=b, description=c, category=e)
    images.save()
...
def add_youtube(request):
    ...
    e = Youtube_category.objects.filter(category=c).first()
    youtube = YouTube.objects.create(title=a, youtube_link=b, category=e)
...
def add_image_category(request):
    a = request.POST.get("category")
    categories = Image_category(category=a)
    categories.save()
    return redirect('images')
...
def add_aboutus(request):
    ...
    b = request.FILES["image"]
    c = request.POST.get("title2")
    bg = Aboutus.objects.create(title1=a, image=b, title2=c)
    return redirect('aboutus')

def add_bg4(request):
    a = request.POST.get("title1")
    b = request.FILES["image"]
    bg = Background_image4.objects.create(title1=a, image=b)
    return redirect('bg2')

def add_bg5(request):
    a = request.POST.get("title1")
    b = request.FILES["image"]
    bg = Background_image5.objects.create(title1=a, image=b)
    return redirect('bg2')
...
def edit_image(request, pk):
    categories = Image_category.objects.all()
    get_image = get_object_or_404(Image, pk=pk)
    # category = Image.objects.get(pk=pk)
    # a = category.category
    if request.method == "POST":
        new_title = request.POST['title']
        new_description = request.POST['description']
        new_category = request.POST['category']
        e = Image_category.objects.filter(category=new_category).first()
...
def edit_youtube(request, pk):
    categories = Youtube_category.objects.all()
    get_youtube = get_object_or_404(YouTube, pk=pk)

    if request.method == "POST":
        new_title = request.POST['title']
        new_youtube_link = request.POST['youtube']
        new_category = request.POST['category']
        e = Youtube_category.objects.filter(category=new_category).first()

        get_youtube.title = new_title
        get_youtube.youtube_link = new_youtube_link
        get_youtube.category = e
        get_youtube.save()
        return redirect('youtube')
    else:
        context = {
        ...
        return render(request, 'nechuadmin/edit_youtube.html', context)
...
def edit_bg4(request, pk):
    get_bg = get_object_or_404(Background_image4, pk=pk)
    if request.method == "POST":
        new_title1 = request.POST['title1']
        ...
        return render(request, 'nechuadmin/edit_bg4.html', context)


def edit_bg5(request, pk):
    get_bg = get_object_or_404(Background_image5, pk=pk)
    if request.method == "POST":
        new_title1 = request.POST['title1']
        ...
        return render(request, 'nechuadmin/edit_bg5.html', context)


def edit_aboutus(request, pk):
    get_bg = get_object_or_404(Aboutus, pk=pk)
    if request.method == "POST":
        new_title1 = request.POST['title1']
        new_title2 = request.POST['title2']
        ...
        return render(request, 'nechuadmin/edit_aboutus.html', context)
