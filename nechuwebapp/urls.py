...
urlpatterns = [
    ...
    path('add_bg5/', views.add_bg5, name='add_bg5'),

    path('edit_bg2/<int:pk>/', views.edit_bg2, name='edit_bg2'),
    path('edit_bg3/<int:pk>/', views.edit_bg3, name='edit_bg3'),
    path('edit_bg4/<int:pk>/', views.edit_bg4, name='edit_bg4'),
    path('edit_bg5/<int:pk>/', views.edit_bg5, name='edit_bg5'),
    ...
    path('edit_aboutus/<int:pk>/', views.edit_aboutus, name='edit_aboutus'),


    path('nechulogin/', views.nechulogin, name="nechulogin"),
    path("SignOut",views.SignOut,name="SignOut"),
    path("bg2",views.bg2,name="bg2"),
    path("add_bg4",views.add_bg4,name="add_bg4"),
    path("aboutus",views.aboutus,name="aboutus"),
    path("add_aboutus",views.add_aboutus,name="add_aboutus"),
