...
class Image(models.Model):
    ...
    image = models.ImageField(upload_to='myimages/', null=True, blank=True)
    description = models.TextField(blank=True)
    category = models.ForeignKey(Image_category, on_delete=models.CASCADE, null=True, blank=True)
    uploaded_date = models.DateTimeField(default=timezone.now, editable=False)
    edited_date = models.DateTimeField(auto_now=True, editable=False)
...
class YouTube(models.Model):
    title = models.CharField(max_length=200)
    youtube_link = models.URLField(blank=True)
    category = models.ForeignKey(Youtube_category, on_delete=models.CASCADE, null=True, blank=True)
    uploaded_date = models.DateTimeField(default=timezone.now, editable=False)
    edited_date = models.DateTimeField(auto_now=True, editable=False)
...
class Background_image4(models.Model):
    image = models.ImageField(upload_to='mybg/')
    title1 = models.CharField(max_length=200)
    title2 = models.CharField(max_length=200)
...
class Background_image5(models.Model):
    image = models.ImageField(upload_to='mybg/')
    title1 = models.CharField(max_length=200)
    title2 = models.CharField(max_length=200)
...
class Background_image7(models.Model):
    image = models.ImageField(upload_to='mybg/')
    title1 = models.CharField(max_length=200)
    title2 = models.CharField(max_length=200)
...
class Background_image8(models.Model):
    image = models.ImageField(upload_to='mybg/')
    title1 = models.CharField(max_length=200)
    title2 = models.CharField(max_length=200)
...
class Background_image9(models.Model):
    image = models.ImageField(upload_to='mybg/')
    title1 = models.CharField(max_length=200)
    title2 = models.CharField(max_length=200)
